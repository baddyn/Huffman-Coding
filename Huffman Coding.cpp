//PROJECT BY BADDYN( NAMAN JAIN)
// FOR IMPLEMENTING HUFFMAN CODING LOSSLESS TEXT COMPRESSION ALGORITHM
// COMBINATION DONE USING OPTIMAL MERGE PATTERN
...
minHeap::minHeap()
{
  ...
  cin>>n;				
	...
	T[0].root=new node;
	T[0].root->freq=n; 
	//Number of elements in min. Heap is stored in the zeroth element of the heap
